...
function FormularioCategoria() {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://fake-api-aluraflix-eight.vercel.app/categorias');
  ...
  const onSubmit = async (data) => {
    try {
      if (editingCategoria) {
        ...
        const response = await fetch(`https://fake-api-aluraflix-eight.vercel.app/categorias/${editingCategoria.id}`,{
          method: "PUT",
          headers: {
        ...
        data.categoriaColor = data.categoriaColor || color;
          await fetch('https://fake-api-aluraflix-eight.vercel.app/categorias',{
          method: "POST",
          headers: {
            'Content-type': "application/json" // Indicates the content 
          },
  ...
  const deleteCategoria = async (id) => {
    try {
      await fetch(`https://fake-api-aluraflix-eight.vercel.app/categorias/${id}`,{
        method: "DELETE",
      });
      fetchData();
      forceUpdate();
        ...
        <Container maxWidth="xl" >
          <form onSubmit={handleSubmit(onSubmit)}>
            <Grid rowSpacing={5} container sx={{
              ...
              <Grid item xs={12}  >
                <Typography align='center' variant='h4' color="#ffffff"  > Nueva Categoria</Typography>
